<?php
class Products_AdminPriceController extends Zendvn_Controller_Action{
//Mang tham so nhan duoc o moi Action
	...
	public function indexAction(){
		$this->view->Title = 'Bảng giá :: Quản trị bảng giá :: Danh sách';
		...
		$this->view->tblGroupCategory = $tblGroupCategory->itemInSelectbox($this->_arrParam, array('task'=>'products'));
	...
	public function addAction(){
		...
		$this->view->Title = 'Bảng giá :: Quản trị bảng giá :: Thêm';
		...
		if($this->_request->isPost()){
			$validator = new Products_Form_ValidatePrice($this->_arrParam);
	...
	public function editAction(){
		...
		$this->view->Title = 'Bảng giá :: Quản trị bảng giá :: Sửa';
	...
	public function sortAction(){
		$tblUser = new Zendvn_Models_Price();
	...
	public function featuredAction(){
		$tblNews = new Zendvn_Models_Price();
	...
	public function infoAction(){
		$this->view->Title = 'Bảng giá :: Quản trị bảng giá :: Thông tin';
		if($this->_arrParam['lang'] == 'en') $this->view->Title = 'Price :: Admin Price :: Information';
		$this->view->headTitle($this->view->Title,true);
		$tblCategory = new Zendvn_Models_Price();
