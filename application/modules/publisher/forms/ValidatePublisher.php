<?php
class Publisher_Form_ValidatePublisher{
	...
	public function __construct($arrParam = array(),$options = null){
		...
		$id = $arrParam['id'];
		if(!isset($id)){
			$options 	= array('table'=>'publisher','field'=>'name');
		}else{
			$clause = ' id !=' . $arrParam['id'];
   			$options = array('table'=>'publisher','field'=>'name','exclude'=>$clause);
		}
		//Kiểm tra Name
	...
	public function uploadFile($filename = null, $options = null){
		...
		$upload_dir = FILES_PATH . '/publisher';
