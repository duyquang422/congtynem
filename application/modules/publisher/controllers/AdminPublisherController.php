<?php
class Publisher_AdminPublisherController extends Zendvn_Controller_Action{
//Mang tham so nhan duoc o moi Action
	...
	public function indexAction(){
		$this->view->Title = 'Nhà sản xuất :: Quản lý Nhà sản xuất :: Danh sách';
		if($this->_arrParam['lang'] == 'en') $this->view->Title = 'Publisher :: Admin Publisher :: List';
	...
	public function addAction(){
		...
		$this->view->Title = 'Nhà sản xuất :: Quản lý Nhà sản xuất :: Thêm mới';
		if($this->_arrParam['lang'] == 'en') $this->view->Title = 'Publisher :: Admin Publisher :: Add';
		$this->view->headTitle($this->view->Title,true);	
		$tblPublisher = new Zendvn_Models_Publisher();			
		if($this->_request->isPost()){
			$validator = new Publisher_Form_ValidatePublisher($this->_arrParam);
	...
	public function editAction(){
		...
		$this->view->Title = 'Nhà sản xuất :: Quản lý Nhà sản xuất :: Sửa';
		if($this->_arrParam['lang'] == 'en') $this->view->Title = 'Publisher :: Admin Publisher :: Edit';
		$this->view->headTitle($this->view->Title,true);
	...
	public function deleteAction(){
		$this->view->Title = 'Publisher :: Admin Publisher :: Delete';
		$this->view->headTitle($this->view->Title,true);
		if($this->_request->isPost())
		{
			$tblPublisher = new Zendvn_Models_Publisher();
	...
	public function sortAction(){
		$tblUser = new Zendvn_Models_Publisher();
	...
	public function featuredAction(){
		$tblNews = new Zendvn_Models_Publisher();
		$tblNews->changeFeatured($this->_arrParam,array('task'=>'featured'));
		$this->_redirect($this->_actionMain);		
		$this->_helper->viewRenderer->setNoRender();
	}
	public function infoAction(){
		$this->view->Title = 'Nhà sản xuất :: Quản lý Nhà sản xuất :: Thông tin';
		if($this->_arrParam['lang'] == 'en') $this->view->Title = 'Publisher :: Admin Publisher :: Information';
		$this->view->headTitle($this->view->Title,true);
		$tblCategory = new Zendvn_Models_Publisher();
