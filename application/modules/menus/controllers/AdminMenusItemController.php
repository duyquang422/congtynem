<?php
class Menus_AdminMenusItemController extends Zendvn_Controller_Action{
	...
	public function indexAction(){
		...
		if($this->_arrParam['lang'] == 'en') $this->view->Title = 'Menus :: Admin Menu :: List';
		...
		$this->view->tblGroupCategory = $tblGroupCategory->itemInSelectbox($this->_arrParam, array('task'=>'all'));
	...
	public function addAction(){
		...
		if($this->_arrParam['lang'] == 'en') $this->view->Title = 'Menus :: Admin Menu :: Add new';
		$this->view->headTitle($this->view->Title,true);
		$tblCategory = new Zendvn_Models_Menus();
		$this->view->tblCategory = $tblCategory->itemInSelectbox($this->_arrParam);
		if($this->_request->isPost()){
			$validator = new Menus_Form_ValidateMenus($this->_arrParam);
	...
	public function editAction(){
		...
		if($this->_arrParam['lang'] == 'en') $this->view->Title = 'Menus :: Admin Menu :: Edit';
		$this->view->headTitle($this->view->Title,true);
		$tblCategory = new Zendvn_Models_Menus();
	...
	public function infoAction(){
		$this->view->Title = 'Chuyên mục :: Quản lý chuyên mục :: Thông tin';
		if($this->_arrParam['lang'] == 'en') $this->view->Title = 'Menus :: Admin Menu :: Information';
		$this->view->headTitle($this->view->Title,true);
		$tblCategory = new Zendvn_Models_Menus();
	...
	function specialAction(){
		$tblCategory = new Zendvn_Models_Menus();
		$tblCategory->changeSpecial($this->_arrParam,array('task'=>'special'));
		$this->_helper->viewRenderer->setNoRender();
	}
	...
	public function deleteAction(){
		$this->view->Title = 'Menus :: Admin Menu :: Delete';
		$this->view->headTitle($this->view->Title,true);
		if($this->_request->isPost())
		{
			$tblProduct = new Zendvn_Models_Menus();
	...
	public function sortAction(){
		$tblUserGroup = new Zendvn_Models_Menus();
		$tblUserGroup ->sortItem($this->_arrParam,array('column'=>'order'));
		$tblUserGroup ->sortItem($this->_arrParam,array('column'=>'positions'));
		$tblUserGroup ->sortItem($this->_arrParam,array('column'=>'sale_off'));
		$tblUserGroup ->sortItem($this->_arrParam,array('column'=>'parents'));
		$this->_redirect($this->_actionMain);
		$this->_helper->viewRenderer->setNoRender();
	}
}
