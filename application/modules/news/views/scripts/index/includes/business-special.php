<?php
	...
	$items = $tblBusiness->listItem($this->arrParam,array('task'=>'special'));
	if(!empty($items)){
?>
<div class="group mar-top-20">
	<div class="sub-content color-blue"><a class="color-blue" href="#">DOANH NGHIỆP TIỀM NĂNG</a></div>
		<?php
