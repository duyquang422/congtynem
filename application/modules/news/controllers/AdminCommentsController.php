<?php
class News_AdminCommentsController extends Zendvn_Controller_Action{
	...
	public function indexAction(){
		$this->view->Title = 'Bình luận tin tức :: Quản lý bình luận :: Danh sách';
		if($this->_arrParam['lang'] == 'en') $this->view->Title = 'Comments News :: Admin Comments :: List';
		$this->view->headTitle($this->view->Title,true);		
		$comment = new Zendvn_Models_CommentsNews();
	...
	public function editAction(){
		...
		$this->view->Title = 'Bình luận tin tức :: Quản lý bình luận :: Sửa';
		if($this->_arrParam['lang'] == 'en') $this->view->Title = 'Comments News :: Admin Comments :: Edit';
		$this->view->headTitle($this->view->Title,true);
		$comment = new Zendvn_Models_CommentsNews();
	...
	public function infoAction(){
		$this->view->Title = 'Bình luận tin tức :: Quản lý bình luận :: Thông tin';
		if($this->_arrParam['lang'] == 'en') $this->view->Title = 'Comments News :: Admin Comments :: Information';
		$this->view->headTitle($this->view->Title,true);
		$comment = new Zendvn_Models_CommentsNews();
	...
	public function deleteAction(){
		$this->view->Title = 'Comments News :: Admin Comments :: Delete';
		$this->view->headTitle($this->view->Title,true);
		if($this->_request->isPost())
		{
			$comment = new Zendvn_Models_CommentsNews();
