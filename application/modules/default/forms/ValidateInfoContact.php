<?php
class Default_Form_ValidateInfoContact{
	...
	public function __construct($arrParam = array(),$options = null){
		...
		$id = $arrParam['id'];
		if(!isset($id)){
			$options 	= array('table'=>'contact','field'=>'title');
		}else{
			$clause = ' id !=' . $arrParam['id'];
   			$options = array('table'=>'contact','field'=>'title','exclude'=>$clause);				
		}
		//Kiểm tra Name
