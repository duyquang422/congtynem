<?php
class InstallmentController extends Zendvn_Controller_Action {
	...
	public function init(){
        ...
        public function indexAction() {
            $this->_helper->layout->setLayout('installment');
            $this->_helper->viewRenderer->setNoRender();
            $product = new Zendvn_Models_Products();
            $this->view->Items = $product->getItem($this->_arrParam,array('task'=>'installment-info'));
        }
}