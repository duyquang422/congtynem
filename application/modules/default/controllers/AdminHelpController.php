<?php
class AdminhelpController extends Zendvn_Controller_Action{
//Mang tham so nhan duoc o moi Action
	...
	public function indexAction(){
		$this->view->Title = 'Help :: Admin Help :: List';
		$this->view->headTitle($this->view->Title,true);
		
		$tblAbout = new Zendvn_Models_Help();
	...
	public function addAction(){
		...
		$this->view->Title = 'Help :: Admin Help :: Add';
		$this->view->headTitle($this->view->Title,true);	
		$tblAbout = new Zendvn_Models_Help();			
		if($this->_request->isPost()){
			$validator = new Default_Form_ValidateHelp($this->_arrParam);
	...
	public function editAction(){
		...
		$this->view->Title = 'Help :: Admin Help :: Edit';
		$this->view->headTitle($this->view->Title,true);
		$tblAbout = new Zendvn_Models_Help();
	...
	public function deleteAction(){
		$this->view->Title = 'Help :: Admin Help :: Delete';
		$this->view->headTitle($this->view->Title,true);
		if($this->_request->isPost())
		{
			$tblAbout = new Zendvn_Models_Help();
	...
	public function sortAction(){
		$tblUser = new Zendvn_Models_Help();
	...
	public function infoAction(){
		$this->view->Title = 'Help :: Admin Help :: Information';
		$this->view->headTitle($this->view->Title,true);
		$tblCategory = new Zendvn_Models_Help();
